...
//Let's say three people signed up for our service, create 3 instances of User and add each to the users Array
  ...
  quizUsers.push(new QuizUser('Ellen', 'ellen@email.com', '1234abcd', 5));
  quizUsers.push(new QuizUser('June', 'june@email.com', 'abcd1234', 10));
  quizUsers.push(new QuizUser('Scarlet', 'scarlet@email.com', 'a1b2c3d4', 11));
...
questions.push(new Question("T/F: In Javascript, ==  -doesn't check 'type' but just the value where === checks type and value", ['T','F'], 'T','hard'));
